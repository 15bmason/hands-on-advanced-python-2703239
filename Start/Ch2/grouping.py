...
with open("C:/Users/bluke/Documents/GitHub/hands-on-advanced-python-2703239/sample-weather-history.json", "r") as weatherfile:
...
for key, data in grouped.items():
    print(f"Precip: {key}, # days: {len(data)}, Data: {list(map(lambda d: d["date"], data))}")